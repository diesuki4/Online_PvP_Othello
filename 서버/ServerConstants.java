...
public class ServerConstants
{
	...
	// 이용할 DB 서버
	public static String DATABASE_IP = "team9.gonetis.com";	// 현재 학생의 컴퓨터에서 실행중인 DB 서버
	public static String DATABASE_PORT = "3306";
	public static String DATABASE_ID = "team9";
	public static String DATABASE_PW = "team91234";
